  ...
  <div class="category-manage">
    ...
    <div class="tips-section">
      <el-alert
        title="操作提示"
        type="info"
        description="支持两级分類管理，一级分類为主分類，二级分類为子分類。刪除分類前請確保该類下沒有子分類和面試真題。"
        show-icon
        :closable="false">
      </el-alert>
    </div>
    ...
    <el-dialog 
      ...
      <el-form 
        ...
        <el-form-item label="分類名稱" prop="name">
          <el-input v-model="categoryForm.name" placeholder="请输入分類名稱"></el-input>
        </el-form-item>
        <el-form-item label="父分類" prop="parentId">
          <el-select 
            v-model="categoryForm.parentId" 
            placeholder="请选择父分類（不选为一级分類）"
            clearable
            style="width: 100%">
            <el-option 
        ...
        <el-form-item label="排序序號" prop="sortOrder">
          <el-input-number 
        ...
        <el-form-item label="分類描述" prop="description">
          <el-input 
            type="textarea" 
    ...
    <el-dialog 
      ...
      <div class="category-detail" v-if="viewCategoryData">
        <div class="detail-row">
          <span class="label">分類名稱：</span>
          <span class="value">{{ viewCategoryData.name }}</span>
        </div>
        <div class="detail-row">
          <span class="label">分類級別：</span>
          <span class="value">
        ...
        <div class="detail-row">
          ...
          <span class="value">
            <el-tag :type="viewCategoryData.status === 1 ? 'success' : 'danger'">
              {{ viewCategoryData.status === 1 ? '啟用' : '禁用' }}
            </el-tag>
          </span>
        </div>
        <div class="detail-row">
          <span class="label">分類描述：</span>
