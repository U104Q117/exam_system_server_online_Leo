<template>
  <div class="home-container">
    <div class="page-header">
      <el-page-header @back="goBack" title="返回" content="選擇試卷開始考試" />
    </div>
    ...
    <div class="paper-list-vertical" v-loading="loading">
        ...
        >
          <div class="paper-info">
            ...
            <div class="paper-meta">
              <span><el-icon><CollectionTag /></el-icon> 題目數量: {{ paper.questionCount }} 道</span>
              <span><el-icon><TrophyBase /></el-icon> 總計分數: {{ paper.totalScore }} 分數</span>
              <span><el-icon><Timer /></el-icon> 考試時間(分鐘): {{ paper.duration }} 分鐘</span>
            </div>
          </div>
      ...
      <el-empty v-else description="暂无已發布試卷或未找到匹配項" />
    </div>
  </div>
</template>
