  ...
  <div class="video-list-page">
    ...
    <div class="page-header">
      <div class="header-main">
        ...
        <p class="page-desc">3分鐘掌握一個技術點，短影片高效學習程式設計技能</p>
      </div>
    </div>
    ...
    <!-- 投稿对话框 -->
    <el-dialog v-model="submitDialogVisible" title="影片投稿" width="600px" :close-on-click-modal="false">
