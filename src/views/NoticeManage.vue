  ...
  <div class="notice-manage-container">
    ...
    <div class="notice-list">
      <el-table :data="noticeList" v-loading="loading" stripe>
        ...
        <el-table-column prop="content" label="內容" min-width="300" show-overflow-tooltip>
        ...
        <el-table-column label="優先級" width="100">
          <template #default="scope">
        ...
        <el-table-column label="操作" width="240" fixed="right">
          <template #default="scope">
            ...
            <el-button size="small" @click="editNotice(scope.row)" icon="Edit">編輯</el-button>
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="700px" :close-on-click-modal="false">
      <el-form :model="noticeForm" :rules="noticeRules" ref="noticeFormRef" label-width="100px">
        <el-form-item label="标题" prop="title">
          <el-input v-model="noticeForm.title" placeholder="請輸入公告標題" />
        </el-form-item>
        <el-form-item label="內容" prop="content">
          <el-input v-model="noticeForm.content" type="textarea" :rows="6" placeholder="請輸入公告內容" />
        </el-form-item>
        <el-form-item label="類型" prop="type">
          <el-select v-model="noticeForm.type" placeholder="請選擇公告類型">
        ...
        <el-form-item label="優先級" prop="priority">
          <el-select v-model="noticeForm.priority" placeholder="請選擇優先級">
        ...
        <el-form-item label="狀態">
          <el-switch v-model="noticeForm.isActive" active-text="啟用" inactive-text="禁用" />
        </el-form-item>
      </el-form>
      <template #footer>
