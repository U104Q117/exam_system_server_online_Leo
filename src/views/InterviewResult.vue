    ...
    <div v-else class="result-content">
        ...
        <div class="score-overview">
          <div class="main-score">
            <div class="score-circle">
              ...
              <div class="score-max">滿分：{{ interviewResult.maxScore }}</div>
            </div>
          </div>
      ...
      <el-card class="questions-card">
        ...
        <el-table :data="interviewResult.answers" stripe>
          <el-table-column prop="questionIndex" label="題號" width="80">
            <template #default="{ row, $index }">
              第{{ $index + 1 }}題
            </template>
          </el-table-column>
          <el-table-column prop="question.questionContent" label="題目" min-width="300"> 
          ...
          <el-table-column label="操作" width="100">
            <template #default="{ row }">
              <el-button size="small" @click="handleViewAnswer(row)">查看詳情</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-card>
      ...
      <div class="action-buttons">
        <el-button type="primary" @click="handleRetryInterview">重新面試官評論</el-button>
        <el-button @click="handleViewDetail">查看詳情</el-button>
        <el-button @click="handleShareResult">分享結果</el-button>
        <el-button @click="$router.push('/interview-questions')">返回真題列表</el-button>
      </div>
    </div>

    <!-- 答题详情对话框 -->
    <el-dialog v-model="answerDetailVisible" title="答題詳情" width="800px">
