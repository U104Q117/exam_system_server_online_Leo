  ...
  <div class="video-detail-page">
    ...
    <div class="video-detail-header">
      ...
      <div class="header-center">
        ...
        <div class="main-title-bg">
          <h1 class="main-title">
            <span class="highlight">3分钟</span>技術短視頻
          </h1>
        </div>
        <!-- 渐变分割线 -->
        <div class="header-divider"></div>
        <div class="sub-title">高效掌握技術點</div>
      </div>
    </div>
    <div class="video-container" v-loading="loading">
            ...
            <div class="video-meta">
              <div class="meta-left">
                <span class="view-count">
                  ...
                  {{ formatNumber(videoInfo.viewCount) }} 次觀看
                </span>
      ...
      <div class="related-videos-section">
        <h3 class="section-title">相關推薦</h3>
          ...
          >
            ...
            <div class="related-video-info">
              ...
              <div class="related-video-meta">
                ...
                <span class="view-count">{{ formatNumber(video.viewCount) }} 次觀看</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- 分享对话框 -->
    <el-dialog v-model="shareDialogVisible" title="分享影片" width="400px">
