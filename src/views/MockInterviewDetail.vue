  ...
  <div class="mock-interview-detail">
    ...
    <div v-else class="detail-content">
        ...
        <div class="interview-meta">
          ...
          <el-row :gutter="20" style="margin-top: 20px;">
            ...
            <el-col :span="6">
              <div class="meta-item">
                <label>總用時：</label>
                <span>{{ interviewDetail.duration }}分鐘</span>
              </div>
            </el-col>
            <el-col :span="6">
              <div class="meta-item">
                ...
                <el-tag :type="interviewDetail.status === 'completed' ? 'success' : 'warning'">
                  {{ interviewDetail.status === 'completed' ? '已完成' : '進行中' }}
                </el-tag>
              </div>
            </el-col>
          </el-row>
      ...
      <div class="action-buttons">
        <el-button type="primary" @click="handleRetryInterview">重新面試</el-button>
        <el-button @click="handleViewResult">查看結果</el-button>
