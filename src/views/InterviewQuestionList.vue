<template>
  <div class="interview-questions">
    ...
    <div class="top-nav">
      <div class="nav-tabs">
        <div class="tab active">熱門企業</div>
      </div>
    </div>

    <!-- 筛选区域 -->
    <div class="filter-section">
      <el-select v-model="filters.direction" placeholder="技術方向" clearable style="width: 180px" @change="handleFilterChange">
        <el-option label="全部" value=""></el-option>
              <el-option label="Java" value="java"></el-option>
              <el-option label="前端" value="frontend"></el-option>
              <el-option label="大數據分析" value="bigdata"></el-option>
      ...
      <el-select v-model="filters.year" placeholder="面試年份" clearable style="width: 120px" @change="handleFilterChange">
        <el-option label="全部" value=""></el-option>
              <el-option
      ...
      <el-input v-model="filters.keyword" placeholder="搜索企業或題目" clearable style="width: 200px" @input="handleFilterChange">
        <template #prefix>
