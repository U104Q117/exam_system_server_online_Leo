  ...
  <div class="interview-question-manage">
    ...
    <div class="search-section">
      <el-form :inline="true" class="search-form">
        <!-- 企业下拉框，宽度加宽到180px -->
        <el-select v-model="searchParams.companyId" placeholder="企業" style="width: 180px; margin-right: 16px;" clearable>
            <el-option 
        ...
        <!-- 分类下拉框，宽度加宽到180px -->
        <el-select v-model="searchParams.categoryId" placeholder="分類" style="width: 180px; margin-right: 16px;" clearable>
            <el-option 
        ...
        <!-- 难度下拉框，宽度加宽到180px -->
        <el-select v-model="searchParams.difficulty" placeholder="難度" style="width: 180px; margin-right: 16px;" clearable>
    ...
    <div class="table-section">
      <el-table 
        ...
        <el-table-column prop="title" label="題目標題" min-width="200"></el-table-column>
        <el-table-column prop="companyName" label="企業" width="120"></el-table-column>
        <el-table-column prop="categoryName" label="分類" width="120"></el-table-column>
        <el-table-column prop="questionType" label="類型" width="100">
        ...
        <el-table-column prop="viewCount" label="查看次數" width="100"></el-table-column>
        <el-table-column prop="likeCount" label="讚數" width="100"></el-table-column>
        ...
        <el-table-column prop="createdTime" label="創建時間" width="180"></el-table-column>
        <el-table-column label="操作" width="200" fixed="right">
          <template #default="scope">
            <el-button size="small" @click="viewQuestion(scope.row)">查看</el-button>
            <el-button size="small" type="primary" @click="editQuestion(scope.row)">編輯</el-button>
    ...
    <el-dialog 
      ...
      <el-form 
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="企業" prop="companyId">
              <el-select v-model="questionForm.companyId" placeholder="請選擇企業" style="width: 100%">
                <el-option 
                  v-for="company in companyOptions" 
                  :key="company.id" 
                  :label="company.name" 
          ...
          <el-col :span="12">
            <el-form-item label="分類" prop="categoryId">
              <el-select v-model="questionForm.categoryId" placeholder="請選擇分類" style="width: 100%">
                <el-option 
                  v-for="category in categoryOptions" 
                  :key="category.id" 
                  :label="category.name" 
        ...
        <el-form-item label="題目標題" prop="title">
          <el-input v-model="questionForm.title" placeholder="請輸入題目標題"></el-input>
        </el-form-item>
        <el-form-item label="題目內容" prop="content">
          <el-input 
            type="textarea" 
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <el-form-item label="難度" prop="difficulty">
              <el-select v-model="questionForm.difficulty" placeholder="請選擇難度" style="width: 100%">
                <el-option label="簡單" :value="1"></el-option>
                <el-option label="中等" :value="2"></el-option>
                <el-option label="困難" :value="3"></el-option>
              </el-select>
        ...
        <el-form-item label="標籤" prop="tags">
          <el-input v-model="questionForm.tags" placeholder="請輸入標籤，多標籤用逗號分隔"></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
    ...
    <el-dialog 
      ...
      <div class="question-detail" v-if="viewQuestionData">
        ...
        <div class="detail-row">
          <span class="label">查看次數：</span>
          <span class="value">{{ viewQuestionData.viewCount }}</span>
        </div>
        <div class="detail-row">
          <span class="label">點讚數：</span>
