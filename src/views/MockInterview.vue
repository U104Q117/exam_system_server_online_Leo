  ...
  <div class="mock-interview">
    ...
    <div v-if="currentStep === 'config'" class="interview-config">
      <div class="config-header">
        <h2>模擬面試配置</h2>
        <p>配置面試參數，開始你的模擬面試之旅</p>
      </div>
      
      <el-card class="config-card">
        <el-form :model="interviewConfig" :rules="configRules" ref="configFormRef" label-width="120px">
          <el-form-item label="技術方向" prop="direction">
            <el-select v-model="interviewConfig.direction" placeholder="選擇技術方向">
          ...
          <el-form-item label="題目數量" prop="questionCount">
            <el-input-number v-model="interviewConfig.questionCount" :min="3" :max="20" :step="1"></el-input-number>
            <span class="form-tip">建議選擇5-10道題目</span>
          </el-form-item>
          
          <el-form-item label="難度級別" prop="difficulty">
            <el-select v-model="interviewConfig.difficulty" placeholder="選擇難度級別"> 
          ...
          <el-form-item label="公司類型" prop="companyType">
            <el-select v-model="interviewConfig.companyType" placeholder="選擇公司類型">
              <el-option label="互聯網大公司" value="large"></el-option>
              <el-option label="中型公司" value="medium"></el-option>
              <el-option label="創建公司" value="startup"></el-option>
            </el-select>
          </el-form-item>
          
          <el-form-item label="面試時長" prop="duration">
            <el-input-number v-model="interviewConfig.duration" :min="15" :max="120" :step="5"></el-input-number>
            <span class="form-tip">分鐘</span>
          </el-form-item>
          
          <el-form-item>
            <el-button type="primary" @click="handleStartInterview" :loading="starting">開始面試</el-button>
    ...
    <div v-if="currentStep === 'interviewing'" class="interview-progress">
      <div class="interview-header">
        ...
        <div class="header-right">
          ...
          <el-button type="danger" @click="handleEndInterview">結束面試</el-button>
        </div>
      </div>
          ...
          <div class="answer-section">
            ...
            <div class="voice-section">
              ...
              <div class="voice-controls">
                ...
                >
                  <i class="el-icon-microphone"></i> 開始錄音
                </el-button>
                <el-button 
                  v-else 
                  type="danger" 
                  @click="stopRecording"
                >
                  <i class="el-icon-video-pause"></i> 停止錄音
                </el-button>
              ...
              <div v-if="currentAnswer.voiceUrl" class="voice-player">
                ...
                <el-button size="small" @click="deleteVoice">刪除錄音</el-button>
              </div>
            </div>
            ...
            <div class="answer-actions">
              ...
              <el-button @click="handleSkipQuestion">跳過此題</el-button>
            </div>
          </div>
        </el-card>
      </div>
      ...
      <el-card class="result-card">
        ...
        <div class="detail-results">
          ...
          <el-table :data="interviewResult.details" stripe>
            <el-table-column prop="questionTitle" label="題目" min-width="200"></el-table-column>
            ...
            <el-table-column prop="aiEvaluation" label="AI評價" min-width="300"></el-table-column>
          </el-table>
        </div>
        
        <div class="result-actions">
          <el-button type="primary" @click="handleViewDetail">查看詳情评分</el-button>
          <el-button @click="handleRetryInterview">重新面試</el-button>
          <el-button @click="$router.push('/interview-questions')">返回真題列表</el-button>
        </div>
      </el-card>
    </div>
  </div>
