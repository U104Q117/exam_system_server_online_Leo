<template>
  <div class="paper-create-container">
    ...
    <el-tabs v-model="activeTab" class="creation-tabs">
      <!-- 手动组卷 -->
      <el-tab-pane label="手動組卷" name="manual">
        <el-form :model="manualForm" ref="manualFormRef" label-width="120px" class="form-section">
          <el-form-item label="试卷名稱" required>
            <el-input v-model="manualForm.name" placeholder="請輸入试卷名稱"></el-input>
          </el-form-item>
          <el-form-item label="考試時間(分鐘)" required>
            <el-input-number v-model="manualForm.duration" :min="1" controls-position="right"></el-input-number>
          </el-form-item>
          <el-form-item label="试卷稱述">
            <el-input type="textarea" v-model="manualForm.description" placeholder="請輸入试卷稱述"></el-input>
          </el-form-item>
        </el-form>
        ...
        <div class="question-selection">
          ...
          <div class="filter-section">
            <el-row :gutter="20">
              <el-col :span="6">
                <!-- 第一个下拉框：选择主类型 -->
                <el-select v-model="selectedType" placeholder="請選擇题目類型" clearable @change="handleTypeChange">
                  <el-option label="選擇題" value="CHOICE"></el-option>
                  <el-option label="判斷題" value="JUDGE"></el-option>  
              ...
              <el-col :span="4">
                <!-- 第三个下拉框：选择难度 -->
                <el-select v-model="selectedDifficulty" placeholder="請選擇題目難度" clearable @change="handleDifficultyChange">
          ...
          <div class="question-table-container">
            ...
            >
              ...
              <el-table-column prop="type" label="題目類型" width="100">
                <template #default="{ row }">
              ...
              <el-table-column prop="difficulty" label="題目難度" width="100">
                <template #default="{ row }">
              ...
              <el-table-column prop="category" label="所属分類" width="120">
                <template #default="{ row }">
            ...
            <div v-if="!loading && filteredQuestions.length === 0" class="empty-state">
              <el-empty description="暂無符合條件的題目" />
            </div>
          </div>
        </div>
      ...
      <!-- AI智能组卷 -->
      <el-tab-pane label="AI智能組卷" name="ai">
        <el-form :model="aiForm" ref="aiFormRef" label-width="120px" class="ai-form">
          
          <el-form-item label="试卷名称" required>
            <el-input v-model="aiForm.name" placeholder="請輸入试卷名稱"></el-input>
          </el-form-item>
          <el-form-item label="考試時間(分鐘)" required>
            <el-input-number v-model="aiForm.duration" :min="1" controls-position="right"></el-input-number>
          </el-form-item>
          <el-form-item label="試卷描述">
            <el-input type="textarea" v-model="aiForm.description" placeholder="請輸入試卷描述"></el-input>
          </el-form-item>
          ...
          <div class="summary-section" style="margin-top: 0;">
             <el-row :gutter="20" align="middle">
                <el-col :span="16">
                  <div class="summary-item">
                    <span class="label">預計總分數：</span>
                    <span class="value">{{ aiTotalScore }} 分數</span>
                  </div>
                   <div class="summary-item" style="margin-left: 20px;">
                    <span class="label">預計總題數：</span>
                    <span class="value">{{ aiTotalCount }} 题</span>
                  </div>
                </el-col>
                <el-col :span="8">
                   <el-button type="primary" @click="handleAiSubmit" size="large">AI一键組卷</el-button>
                </el-col>
             </el-row>
          </div>
        </el-form>
