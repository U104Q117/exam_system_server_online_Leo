  ...
  <div class="home-page">
    ...
    <div class="navbar">
      <div class="logo">
        ...
        <span class="title">智能學習平台</span>
      </div>
      <div class="nav-actions">
        <el-button type="primary" @click="goToExam" icon="Document">考試入口</el-button>
        <el-button @click="goToRanking" icon="Trophy">考試排行榜</el-button>
        <el-button @click="showAdminLogin" icon="Edit">管理員後台</el-button>
      </div>
    </div>
      ...
      <div class="hero-section">
        ...
        <div class="notice-section">
          <div class="notice-header">
            ...
            <span class="notice-title">系統公告</span>
          </div>
    ...
    <el-dialog v-model="adminLoginVisible" title="管理员登录" width="400px" :close-on-click-modal="false">
      ...
      <template #footer>
        ...
        <el-button type="primary" @click="handleAdminLogin" :loading="adminLoginLoading">登入</el-button>
      </template>
    </el-dialog>
