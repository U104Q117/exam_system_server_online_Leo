    ...
    <div v-else class="practice-content">
      ...
      <el-card class="answer-card">
        ...
        <el-form :model="answerForm" :rules="answerRules" ref="answerFormRef">
          <el-form-item label="文字作答" prop="text">
            <el-input v-model="answerForm.text" type="textarea" :rows="6" placeholder="請詳細描述你的答案..."></el-input>
          </el-form-item>
          <el-form-item label="語音作答">
            <div class="voice-section">
              ...
              <div v-if="answerForm.voiceUrl" class="voice-player">
                ...
                <el-button size="small" @click="deleteVoice">刪除音檔</el-button>
              </div>
            </div>
          </el-form-item>
          <el-form-item>
      ...
      <el-card class="ai-score-card" v-if="aiScore">
        ...
        <div class="score-section">
          ...
          <div class="score-comment">AI評價{{ aiScore.comment }}</div>
        </div>
      </el-card>
    </div>
  </div>
