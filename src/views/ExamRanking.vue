<template>
  <div class="exam-ranking-page">
    ...
    <div class="page-header">
      ...
      <h2 class="main-title">🏆 考試排行榜 🏆</h2>
      <p class="subtitle">🎯 挑戰極限，追求卓越！看看誰是學霸之王？</p>
      ...
      <div class="ranking-container">
        ...
        <div v-if="rankingList.length > 0" class="champion-showcase">
          ...
          <div class="champion-info">
            ...
            <div class="champion-title">🎉當前考試之王！🎉</div>
          </div>
        </div>
        ...
        <div v-else class="empty-state">
          ...
          <div class="empty-text">暫無排行榜數據</div>
          <div class="empty-hint">快去参加考試，成為第一個上榜的人吧！</div>
        </div>
      </div>
    ...
    <div class="motivation-section">
      <div class="motivation-text">💪 每一次挑戰都是成長機會！加油冲刺更高的排名吧！</div>
