    ...
    <div v-else-if="examRecord" class="result-container">
      ...
      <div class="completion-notice">
        <div class="notice-content">
          ...
          <div class="notice-text">
            <h4>🎉 考試已完成</h4>
            <p>您的答卷已成功提交並批核完成。請查看下方的詳細成績和分析報告。</p>
            <p class="notice-tip">💡 考試已結束，無法再次修改答案。如需重新挑战請返回考試列表選擇新的考試。</p>
          </div>
        </div>
      </div>
      ...
      <div class="result-header">
        <div class="header-left">
          <h2>🎓 考試結果</h2>
          <div class="exam-info">
            <p><strong>📋 试卷名稱：</strong>{{ examRecord.paper.name }}</p>
            <p v-if="examRecord.studentName"><strong>👤 考生姓名：</strong>{{ examRecord.studentName }}</p>
            <p><strong>📅 考試時間：</strong>{{ formatDateTime(examRecord.startTime) }}</p>
          </div>
        </div>
      ...
      <div class="score-section">
        <div class="score-rank-card">
          <div class="score-rank-main">
            ...
            <div class="score-block">
              <div class="score-badge">
                ...
                <div class="score-main">
                  <div class="score-label">考試成績</div>
            ...
            <div v-if="rankingInfo" class="rank-block">
              <div class="rank-top">
                ...
                <div class="rank-title">本試卷排名</div>
              </div>
              <div class="rank-info">
                <div class="rank-participants">共 {{ rankingInfo.totalParticipants }} 人參與</div>
          ...
          <div class="score-rank-footer">
            ...
            <div class="challenge-actions">
              <el-button type="primary" size="small" @click="retakeChallenge" class="challenge-btn">🚀 再次挑戰</el-button>
        ...
        <div class="score-details">
          ...
          <div class="detail-item">
            <div class="detail-icon">📝</div>
            <div class="detail-info">
              <div class="detail-label">題目總數</div>
          ...
          <div class="detail-item">
            <div class="detail-icon">✅</div>
            <div class="detail-info">
              <div class="detail-label">答對題數</div>
          ...
          <div class="detail-item">
            <div class="detail-icon">❌</div>
            <div class="detail-info">
              <div class="detail-label">答錯題數</div>
          ...
          <div class="detail-item">
            <div class="detail-icon">🔶</div>
            <div class="detail-info">
              <div class="detail-label">部分正確</div>
