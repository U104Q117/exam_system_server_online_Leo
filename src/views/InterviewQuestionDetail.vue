        ...
        <template #header>
          <div class="card-header">
            ...
            <div class="header-actions">
              <el-button type="primary" @click="handleStartPractice">開始練習</el-button>
            ...
            <el-col :span="6">
              <div class="meta-item">
                ...
                <el-tag :type="question.status === 'approved' ? 'success' : 'warning'">
                  {{ question.status === 'approved' ? '已審核' : '待審核' }}
                </el-tag>
              </div>
            </el-col>
          </el-row>
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8">
              <div class="stat-item">
                ...
                <div class="stat-label">評價總數</div>
              </div>
            </el-col>
            <el-col :span="8">
              <div class="stat-item">
                <div class="stat-number">{{ evaluationStats.difficultyRating }}</div>
                <div class="stat-label">難度評分</div>
