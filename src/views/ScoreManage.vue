<template>
  <div class="score-manage-container">
    <div class="search-bar">
      ...
      <el-input v-model="searchForm.studentNumber" placeholder="學號/工號" clearable style="width: 200px" @input="handleSearch" />
      <el-select v-model="searchForm.status" placeholder="考試狀態" clearable style="width: 150px" @change="handleSearch">
        <el-option label="進行中" :value="0" />
        <el-option label="已完成" :value="1" />
        <el-option label="已批閱" :value="2" />
      </el-select>
      <el-date-picker
    ...
    <div class="table-container">
      <el-table :data="examRecords" v-loading="loading" stripe style="width: 100%">
        <el-table-column prop="id" label="記錄ID" width="80" />
        <el-table-column prop="studentName" label="考生姓名" width="120" />
        <el-table-column prop="studentNumber" label="學號/工號" width="120" />
        <el-table-column prop="paper.name" label="试卷名稱" min-width="200" />
        ...
        <el-table-column prop="paper.totalScore" label="總分" width="100" />
