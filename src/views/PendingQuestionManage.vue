<template>
  <div class="pending-question-manage">
    <!-- 顶部操作栏：上传真题按钮 -->
    <div class="toolbar">
      <el-button type="primary" @click="uploadDialogVisible = true">上傳真題</el-button>
    </div>
    ...
    <el-form :inline="true" :model="filters" class="filter-form" style="margin-bottom: 20px;">
      ...
      <el-form-item label="關鍵字">
        <el-input v-model="filters.keyword" placeholder="題目描述/聯絡方式" style="width: 200px" />
      </el-form-item>
      <el-form-item>
    ...
    <!-- 上传真题弹窗 -->
    <el-dialog v-model="uploadDialogVisible" title="上傳我的真題" width="500px">
      <el-form :model="uploadForm" label-width="80px">
        <el-form-item label="題目描述">
          <el-input v-model="uploadForm.content" type="textarea" rows="3" placeholder="請輸入題目描述" />
        </el-form-item>
        ...
        <el-form-item label="聯絡方式">
          <el-input v-model="uploadForm.contact" placeholder="選填，便于聯絡你" />
        </el-form-item>
      </el-form>
      <template #footer>
    ...
    <el-table :data="list" style="width: 100%; margin-top: 20px;" v-loading="loading">
      ...
      <el-table-column prop="content" label="題目描述" min-width="200" />
      ...
      <el-table-column prop="status" label="状态" width="90">
        <template #default="scope">
          <el-tag v-if="scope.row.status === 0" type="warning">待審核</el-tag>
