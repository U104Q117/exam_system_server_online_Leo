  ...
  <div class="practice-page">
    ...
    <div class="navbar">
      ...
      <div class="nav-actions">
        ...
        <el-button type="primary" @click="goToExam" icon="Document">考試入口</el-button>
        <el-button @click="showStats" icon="DataAnalysis">練計統計</el-button>
        <el-button type="danger" @click="resetAllPractice" icon="Delete">重置練計記錄</el-button>
      </div>
    </div>
    ...
    <div class="main-content">
      ...
      <div class="content-area">
        ...
        <div v-if="searchForm.collected" class="collected-mode-tip">
          ...
          >
            <template #default>
              共找到 <strong>{{ pagination.total }}</strong> 道收藏項目，点击"返回刷题"可切换到正常模式
            </template>
          </el-alert>
        </div>
          ...
          >
            ...
            <div class="question-content">
              ...
              <div v-if="question.type === 'JUDGE'" class="judge-options">
                ...
                >
                  <el-radio label="TRUE" size="large">正確</el-radio>
                  <el-radio label="FALSE" size="large">錯誤</el-radio>
                </el-radio-group>
              </div>
    ...
    <!-- 练习统计对话框 -->
    <el-dialog v-model="statsDialogVisible" title="練習統計" width="600px">
      <div class="stats-content">
        ...
        <div class="stats-detail">
          ...
          <el-table :data="practiceStats.categoryStats" style="width: 100%">
            ...
            <el-table-column prop="totalCount" label="總題數" width="80" />
            <el-table-column prop="answeredCount" label="已練習" width="80" />
            <el-table-column prop="correctRate" label="正確率" width="80">
